                            ...
                            <div class="col">
                                <?php if (isset($artikelData)) : ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" id="meta_description_id" name="meta_description_id"><?= $artikelData->meta_description_id; ?></textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" id="meta_description_en" name="meta_description_en"><?= $artikelData->meta_description_en; ?></textarea>
                                    </div>
