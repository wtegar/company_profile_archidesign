                            ...
                            <table class="table app-table-hover mb-0 text-left">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" valign="middle">Judul Artikel (EN)</th> <!-- Kolom baru -->
                                        <th class="text-center" valign="middle">Deskripsi Artikel</th>
                                        <th class="text-center" valign="middle">Deskripsi Artikel (EN)</th> <!-- Kolom baru -->
                                ...
                                <tbody>
                                    <?php foreach ($artikels as $artikel) : ?>
                                        <tr>
                                            ...
                                            <td><?= $artikel->judul_artikel_en ?></td> <!-- Menampilkan judul artikel dalam bahasa Inggris -->
                                            <td><?= $artikel->deskripsi_artikel ?></td>
                                            <td><?= $artikel->deskripsi_artikel_en ?></td> <!-- Menampilkan deskripsi artikel dalam bahasa Inggris -->
