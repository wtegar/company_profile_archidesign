                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="slug_in" name="slug_in" value="<?= $aktivitasData->slug_id; ?>" readonly>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="slug_en" name="slug_en" value="<?= $aktivitasData->slug_en; ?>" readonly>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="meta_title_in" name="meta_title" value="<?= $aktivitasData->meta_title; ?>">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Meta Title (En)</label>
                                    <input type="text" class="form-control" id="meta_title_en" name="meta_title_en" value="<?= $aktivitasData->meta_title_en; ?>">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Meta Description (In)</label>
                                    <textarea type="text" class="form-control" id="meta_description_in" name="meta_description"><?= $aktivitasData->meta_description; ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Meta Description (En)</label>
                                    <textarea type="text" class="form-control" id="meta_description_en" name="meta_description_en"><?= $aktivitasData->meta_description_en; ?></textarea>
                                </div>
                                <div class="mb-3">
