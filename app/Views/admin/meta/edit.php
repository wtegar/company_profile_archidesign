                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="meta_title_en" name="meta_title_en" value="<?= old('meta_title_en', $metaData->meta_title_en) ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="meta_description_en" name="meta_description_en" value="<?= old('meta_description_en', $metaData->meta_description_en) ?>">
                                </div>
