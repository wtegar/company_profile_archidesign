...
<?php foreach ($profil as $header) : ?>
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0z">
            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu text-capitalize" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item <?= $lang === 'en' ? 'disabled bg-secondary text-light' : '' ?>" href="<?= $english_url ?>">
                            <i class="fa fa-flag"></i> English
                        </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item <?= $lang === 'id' ? 'disabled bg-secondary text-light' : '' ?>" href="<?= $indonesia_url ?>">
                            <i class="fa fa-flag"></i> Indonesia
                        </a>
                    </div>
                </div>
            </div>
