...
$routes->get('admin/meta', 'admin\MetaController::index');
...
$routes->delete('admin/meta/delete/(:num)', 'admin\MetaController::delete/$1');
...
// // route halaman about
// $routes->get('about', 'user\Aboutctrl::index');
// // routes halaman produk
// $routes->get('product', 'user\Productsctrl::index');
// $routes->get('product/detail/(:segment)', 'user\Productsctrl::detail/$1'); // Perbarui ini untuk hanya menerima slug

// // routes halaman aktivitas
// $routes->get('activities', 'user\Aktivitasctrl::index');
// // Ganti ini untuk hanya menerima slug
// $routes->get('activities/detail/(:any)', 'user\Aktivitasctrl::detail/$1');
...
// // routes halaman artikel
// $routes->get('artikel', 'user\Artikelctrl::index');
// $routes->get('artikel/detail/(:segment)', 'user\Artikelctrl::detail/$1');``
