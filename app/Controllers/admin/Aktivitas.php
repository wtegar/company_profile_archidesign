...
class Aktivitas extends BaseController
{
    ...
    public function proses_tambah()
    {
        ...
        if (!$this->validate([
            ...
            // Panggil metode saveAktivitas untuk menyimpan data dengan slug
            $aktivitasModel->saveAktivitas($data);
    ...
    public function proses_edit($id_aktivitas = null)
    {
        ...
        $data['slug_id'] = $aktivitasModel->generateSlug($nama_aktivitas_in);
        $data['slug_en'] = $aktivitasModel->generateSlug($nama_aktivitas_en);
